...
function DashboardContent() {
  // Activate the progressive fetch loop
  useTickets();
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 px-6 py-6 space-y-6 max-w-[1600px] mx-auto w-full">
        ...
        {/* Dashboard — visible as soon as first page arrives */}
        {tickets.length > 0 && (
          <>
            <section>
              <KpiGrid />
            ...
            {/* Progressive loading banner — shown while more pages are being fetched */}
            {showProgressBanner && (
        ...
        {/* Empty state — before first search or no results */}
        {!isLoading && tickets.length === 0 && !error && (
          <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
            ...
            <p className="text-gray-500 font-medium">
              {hasSearched ? 'Nenhum ticket encontrado para os filtros selecionados.' : 'Selecione o período e clique em Buscar'}
            </p>
            {!hasSearched && (
