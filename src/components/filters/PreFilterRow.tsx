...
export function PreFilterRow() {
  ...
  // Subtipos filtrados pelo tipo e brand atualmente selecionados
    ...
    <div className="flex flex-wrap gap-3">
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={(e) => {
            // Ao mudar o tipo, zera o subtipo para evitar seleção inválida
            setPreFilter({ tipoZd: e.target.value, subtipo: '' });
          }}
          className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
