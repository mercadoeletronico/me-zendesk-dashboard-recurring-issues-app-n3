...
export function KpiGrid() {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
      <KpiCard label="Total de Tickets" value={formatNumber(kpis.total)} accent="blue"
      ...
      />
      <KpiCard label="Clientes Ativos" value={formatNumber(kpis.clientesAtivos)} accent="green"
      ...
      />
      <KpiCard label="Maior Recorrência (Geral)" value={`${geralDias} dias`} subtitleList={geralSubtipos} accent="purple"
      ...
      />
      <KpiCard label="Maior Recorrência por Cliente" value={`${cliRec} dias`} subtitleList={cliEntries} accent="rose"
